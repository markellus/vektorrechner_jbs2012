...
{
    /// <summary>
    /// This is a camera object used to keep track of the position and rotation of a camera. Use of the camera
    /// will affect how models are shown in a scene.
    /// </summary>
    public class QatCamera
    {
        ...
        public QatCamera(Viewport newViewport)
        {
        ...
        public void Update()
        {
            ...
            Matrix.CreatePerspectiveFieldOfView(MathHelper.Pi / 2.5f,
                (float)m_Viewport.Width / (float)m_Viewport.Height, m_Viewport.MinDepth, m_Viewport.MaxDepth, out m_mtxProjection);
        }
#endregion
